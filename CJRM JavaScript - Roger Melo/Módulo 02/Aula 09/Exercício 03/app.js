...
// console.log(
//   ` O crazyArray tem ${booleanAmount} booleans, ${numbersAmount} números e ${stringAmount} strings.`
// );
...
console.log(`Numeros ímpares: ${oddNumbers.join(", ")}. Números pares: ${evenNumbers.join(", ")}.`);
