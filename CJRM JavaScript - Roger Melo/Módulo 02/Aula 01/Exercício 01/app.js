...
*/
const my3FavoriteTVShows = ["FRIENDS", "Manifest", "Emily in Paris"];
const sentence = `Minhas 3 séries favoritas são: ${my3FavoriteTVShows.join(", ")}.`.replace(
  ", E",
  " e E"
);
...
// console.log(
//   `A string que a "typeSentence" armazena tem mais de ${numberToCheck} caracteres? ${
//     String(typeSentence.length) > numberToCheck
//   }.`
// );
