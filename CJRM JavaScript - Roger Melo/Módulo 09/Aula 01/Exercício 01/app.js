...
numbersCopy.sort((item1, item2) => item1 - item2)
...
const cookedIngredients = ingredients.reduce((acc, item) => `${acc} ${item} cozido, `, '')
...
const disneyMovie = topBrazilMovies.filter(movie => movie.distributedBy === 'Disney');

console.log(disneyMovie.length)
