...
/*
  ...
  - Exiba o objeto no console.
*/
const past = new Date('Jan 03 2023 20:58:00');
console.log(past);
/*
  05
...
/*
  ...
  - Exiba o objeto no console.
*/
const future = new Date('Jan 03 2024 20:58:00');
console.log(future);
/*
  07
...
*/
const between = future.getTime() - past.getTime();

const betweenDays = Math.round(between / 1000 / 60 / 60 / 24);
