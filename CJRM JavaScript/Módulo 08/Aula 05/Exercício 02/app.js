...
const numbersSmallerThan501 = crazyNumbers.filter(item => item < 501);

console.log(numbersSmallerThan501.length);
...
const productList = cart.reduce(
  (accumulator, product) => `${accumulator}- ${product.name}\n`,
  '',
);
...
const releaseMovie = tarantinoMovies.filter(movie => movie.release < 2000);

console.log(releaseMovie);
