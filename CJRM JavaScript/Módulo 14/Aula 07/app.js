...
*/
const slides = document.querySelectorAll('[data-js="caroussel__item"]');
const nextButton = document.querySelector(
  '[data-js="caroussel__button--next"]',
);
const prevButton = document.querySelector(
  '[data-js="caroussel__button--prev"]',
);

let currentSlideIndex = 0;

const manipulatedSlidesClasses = correctSlideIndex => {
  slides.forEach(slide => slide.classList.remove('caroussel__item--visible'));
  slides[correctSlideIndex].classList.add('caroussel__item--visible');
};
