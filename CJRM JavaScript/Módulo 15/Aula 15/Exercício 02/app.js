...
const closeAccordionItem = () => {
  ...
  accordionHeaderToBeClosed.classList.remove();
  accordionBodyToBeCLosed.classList.remove();
};

accordion.addEventListener('click', e => {
  const accordionHeaderId = e.target.dataset.accordionHeader;
  const clickAccordionHearder = document.querySelector(
  ...
  const accordionHeaderToBeClosed = Array.from(
    document
      .querySelector('[data-js="accordion-header"]')
      .filter(accordionHeader => accordionHeader !== clickAccordionHearder)
