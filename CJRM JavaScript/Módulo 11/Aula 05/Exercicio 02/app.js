...
*/
const threeArguments = 'A função deve ser invocada com 3 argumentos';
const invoked = 'A função foi invocada com 3 argumentos';

const takesThreeArg = (param1, param2, param3) => {
...
console.log(takesThreeArg(1, 2, 3));
