...
const south = ['Santa Catarina', 'Paraná', 'Rio Grande do Sul'];
const southEast = [
  'Minas Gerais',
  'Espírito Santo',
  'Rio de Janeiro',
...
let brasil = south.concat(southEast);
brasil.unshift('Amazonas', 'Acre', 'Rondônia');

console.log(brasil);

const newSouth = brasil.slice(2, 5);
...
const newSouthEast = brasil.splice(5, 4);
brasil = brasil.concat(northEast);
